...
4. and for books with a full or partial preview,
   the Google book reader for the volume.
...
the framework. The googlebook module API is different based on the
...
display that data within the Google Book module. The API pulls data
